...
<head>
    ...
    <style>
        ...
        .img-thumb { width: 80px; height: 50px; object-fit: cover; border-radius: 8px; }
        .btn-add { background: #38bdf8; color: #0f172a; border-radius: 12px; padding: 10px 24px; font-weight: 700; border: none; }
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn-add shadow-sm" data-bs-toggle="modal" data-bs-target="#addBlog"><i class="fas fa-pen-nib me-2"></i> Tulis Artikel</button>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="small text-muted">/blog/<?= $b['slug'] ?></div>
                    </td>
                    <td><span class="text-muted small fw-bold"><?= date('d M Y', strtotime($b['created_at'])) ?></span></td>
                    <td class="text-end">
                        <a href="?delete=<?= $b['id'] ?>" class="btn btn-sm btn-light text-danger p-2" onclick="return confirm('Hapus artikel ini?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
            ...
            <div class="modal-body p-4">
                <div class="row g-4">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="title" class="form-control rounded-3 py-2" required placeholder="Contoh: Tips Umroh Saat Ramadhan">
                        
                        <label class="small fw-bold mt-3 mb-1">Isi Konten</label>
                        <textarea name="content" class="form-control rounded-3" rows="12" placeholder="Tulis artikel lengkap di sini..." required></textarea>
                    </div>
                    <div class="col-md-4">
                        <div class="p-4 bg-light rounded-4">
                            ...
                            <div class="alert alert-info border-0 small">
                                <i class="fas fa-info-circle me-1"></i> Gunakan gambar berkualitas tinggi untuk thumbnail blog.
                            </div>
                        </div>
                    </div>
                </div>
