    ...
    <div class="modal-dialog modal-lg">
        <form method="POST" enctype="multipart/form-data" class="modal-content shadow-lg">
            <div class="modal-header border-0 p-4 pb-0">
                <h5 class="fw-bold">Tambah Paket Wisata</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body p-4">
                <div class="row g-3">
                    <div class="col-md-8"><label class="small fw-bold mb-1">Judul Paket</label><input type="text" name="title" class="form-control rounded-3" required></div>
            ...
            <div class="modal-footer border-0 p-4 pt-0">
                <button type="submit" name="add_package" class="btn-add w-100">Simpan Paket</button>
            </div>
        </form>
    </div>
</div>
